    ...
    equiposData.forEach(equipo => {
        ...
        card.innerHTML = `
            <div class="equipo-header">
                <div class="coche-placeholder" style="height: 175px; margin-bottom: 1px; display: flex; align-items: center; justify-content: center;">
                    ${equipo.imagenCoche ? `<img src="${equipo.imagenCoche}" alt="Coche ${equipo.nombre}" style="width: 140%; height: 140%; object-fit: contain; transform: scale(1.3); filter: drop-shadow(0px 10px 15px rgba(0,0,0,0.6));">` : '<span style="color: var(--text-secondary);">Foto Coche</span>'}
                </div>
